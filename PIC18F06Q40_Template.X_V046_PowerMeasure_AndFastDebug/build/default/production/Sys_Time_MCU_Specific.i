...
# 9 "Sys_Time_MCU_Specific.c" 2
# 24 "Sys_Time_MCU_Specific.c"
void Sys_Time_Init(void)
{
...
wake_cause_t Sys_Time_EnterDeepSleep(void)
{
    ...
    TMR0H = ((uint8_t)(((10000 * 31UL) + (1UL << (14u - 1u))) / (1UL << 14u)));
    TMR0L = 0x00u;
    PIR3bits.TMR0IF = 0;
    PIE3bits.TMR0IE = 1;
