...
#elif (COMPRESS_METHOD_SELECTED == COMPRESS_METHOD_PACK_10_14) 
    #include "Compress_Pack_10_14.h"   
#elif (COMPRESS_METHOD_SELECTED == COMPRESS_METHOD_NOCOMP_16)
    #include "Compress_NoComp_16.h"
#else
