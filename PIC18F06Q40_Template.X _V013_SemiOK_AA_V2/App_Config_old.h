...
#define REPORT_CONFIG_DEBUG
  ...
  #define APP_FLOW_BATCH      360u          /* samples per report batch */
#endif
...
#define COMPRESS_METHOD_NOCOMPRESS_2B_2B   0   /* 2B time + 2B pulses = 4 B/sample | 4KB for 1000 batch */
#define COMPRESS_METHOD_PACK_10_10_4       1   /* 10b grp + 10b pulses + 4b unused = 3 B | 3KB for 1000 batcg */ 
