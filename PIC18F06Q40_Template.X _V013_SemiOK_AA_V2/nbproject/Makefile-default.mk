...
FINAL_IMAGE=${DISTDIR}/PIC18F06Q40_Template.X__V013_SemiOK_AA_V2.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=main.c Dev_Led.c MCU_Time.c Sys_Time_MCU_Specific.c Dev_Uart.c PulseCounter.c FlowMeter.c FlowLog.c FlowReport.c Compress_NoComp_2B_2B.c led_fsm_sysstate.c Compress_Pack_10_10_4.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/Dev_Led.p1 ${OBJECTDIR}/MCU_Time.p1 ${OBJECTDIR}/Sys_Time_MCU_Specific.p1 ${OBJECTDIR}/Dev_Uart.p1 ${OBJECTDIR}/PulseCounter.p1 ${OBJECTDIR}/FlowMeter.p1 ${OBJECTDIR}/FlowLog.p1 ${OBJECTDIR}/FlowReport.p1 ${OBJECTDIR}/Compress_NoComp_2B_2B.p1 ${OBJECTDIR}/led_fsm_sysstate.p1 ${OBJECTDIR}/Compress_Pack_10_10_4.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/Dev_Led.p1.d ${OBJECTDIR}/MCU_Time.p1.d ${OBJECTDIR}/Sys_Time_MCU_Specific.p1.d ${OBJECTDIR}/Dev_Uart.p1.d ${OBJECTDIR}/PulseCounter.p1.d ${OBJECTDIR}/FlowMeter.p1.d ${OBJECTDIR}/FlowLog.p1.d ${OBJECTDIR}/FlowReport.p1.d ${OBJECTDIR}/Compress_NoComp_2B_2B.p1.d ${OBJECTDIR}/led_fsm_sysstate.p1.d ${OBJECTDIR}/Compress_Pack_10_10_4.p1.d
...
# Source Files
SOURCEFILES=main.c Dev_Led.c MCU_Time.c Sys_Time_MCU_Specific.c Dev_Uart.c PulseCounter.c FlowMeter.c FlowLog.c FlowReport.c Compress_NoComp_2B_2B.c led_fsm_sysstate.c Compress_Pack_10_10_4.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/PIC18F06Q40_Template.X__V013_SemiOK_AA_V2.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/Compress_NoComp_2B_2B.p1: Compress_NoComp_2B_2B.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Compress_NoComp_2B_2B.p1.d 
	@${RM} ${OBJECTDIR}/Compress_NoComp_2B_2B.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=pickit5   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/Compress_NoComp_2B_2B.p1 Compress_NoComp_2B_2B.c 
	@-${MV} ${OBJECTDIR}/Compress_NoComp_2B_2B.d ${OBJECTDIR}/Compress_NoComp_2B_2B.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/Compress_NoComp_2B_2B.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/Compress_Pack_10_10_4.p1: Compress_Pack_10_10_4.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Compress_Pack_10_10_4.p1.d 
	@${RM} ${OBJECTDIR}/Compress_Pack_10_10_4.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=pickit5   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/Compress_Pack_10_10_4.p1 Compress_Pack_10_10_4.c 
	@-${MV} ${OBJECTDIR}/Compress_Pack_10_10_4.d ${OBJECTDIR}/Compress_Pack_10_10_4.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/Compress_Pack_10_10_4.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/PIC18F06Q40_Template.X__V013_SemiOK_AA_V2.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/PIC18F06Q40_Template.X__V013_SemiOK_AA_V2.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=pickit5  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/PIC18F06Q40_Template.X__V013_SemiOK_AA_V2.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/PIC18F06Q40_Template.X__V013_SemiOK_AA_V2.${IMAGE_TYPE}.hex 
	
	
else
${DISTDIR}/PIC18F06Q40_Template.X__V013_SemiOK_AA_V2.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/PIC18F06Q40_Template.X__V013_SemiOK_AA_V2.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/PIC18F06Q40_Template.X__V013_SemiOK_AA_V2.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
