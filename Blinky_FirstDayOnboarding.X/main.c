/*
 * Blinky_FirstDayOnboarding.X / main.c
 * First-day onboarding: PIC18 LED blink, then later lessons.
 *
 * ---------------------------------------------------------------------
 * HOW TO USE
 * ---------------------------------------------------------------------
 * This copy starts on LESSON 4 (blink). Change the LESSON number below,
 * then Build + "Make and Program Device". Only one lesson compiles at a time.
 *
 *   #define LESSON 4   ->  blink test        (start here — first day)
