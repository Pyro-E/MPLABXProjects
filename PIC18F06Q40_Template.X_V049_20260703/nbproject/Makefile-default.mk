...
FINAL_IMAGE=${DISTDIR}/PIC18F06Q40_Template.X_V049_20260703.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=main.c Dev_Led.c MCU_Time.c Sys_Time_MCU_Specific.c Dev_Uart.c PulseCounter.c FlowMeter.c FlowLog.c FlowReport.c led_fsm_sysstate.c Compress_Pack_10_14.c Dev_Valve.c Flow_Control.c MValve_OP3.c Packet.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/Dev_Led.p1 ${OBJECTDIR}/MCU_Time.p1 ${OBJECTDIR}/Sys_Time_MCU_Specific.p1 ${OBJECTDIR}/Dev_Uart.p1 ${OBJECTDIR}/PulseCounter.p1 ${OBJECTDIR}/FlowMeter.p1 ${OBJECTDIR}/FlowLog.p1 ${OBJECTDIR}/FlowReport.p1 ${OBJECTDIR}/led_fsm_sysstate.p1 ${OBJECTDIR}/Compress_Pack_10_14.p1 ${OBJECTDIR}/Dev_Valve.p1 ${OBJECTDIR}/Flow_Control.p1 ${OBJECTDIR}/MValve_OP3.p1 ${OBJECTDIR}/Packet.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/Dev_Led.p1.d ${OBJECTDIR}/MCU_Time.p1.d ${OBJECTDIR}/Sys_Time_MCU_Specific.p1.d ${OBJECTDIR}/Dev_Uart.p1.d ${OBJECTDIR}/PulseCounter.p1.d ${OBJECTDIR}/FlowMeter.p1.d ${OBJECTDIR}/FlowLog.p1.d ${OBJECTDIR}/FlowReport.p1.d ${OBJECTDIR}/led_fsm_sysstate.p1.d ${OBJECTDIR}/Compress_Pack_10_14.p1.d ${OBJECTDIR}/Dev_Valve.p1.d ${OBJECTDIR}/Flow_Control.p1.d ${OBJECTDIR}/MValve_OP3.p1.d ${OBJECTDIR}/Packet.p1.d
...
# Source Files
SOURCEFILES=main.c Dev_Led.c MCU_Time.c Sys_Time_MCU_Specific.c Dev_Uart.c PulseCounter.c FlowMeter.c FlowLog.c FlowReport.c led_fsm_sysstate.c Compress_Pack_10_14.c Dev_Valve.c Flow_Control.c MValve_OP3.c Packet.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/PIC18F06Q40_Template.X_V049_20260703.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/PIC18F06Q40_Template.X_V049_20260703.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/PIC18F06Q40_Template.X_V049_20260703.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=pickit5  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/PIC18F06Q40_Template.X_V049_20260703.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/PIC18F06Q40_Template.X_V049_20260703.${IMAGE_TYPE}.hex 
	
	
else
${DISTDIR}/PIC18F06Q40_Template.X_V049_20260703.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/PIC18F06Q40_Template.X_V049_20260703.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/PIC18F06Q40_Template.X_V049_20260703.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
