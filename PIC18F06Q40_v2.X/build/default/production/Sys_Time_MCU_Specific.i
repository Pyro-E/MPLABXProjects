...
# 7 "Sys_Time_MCU_Specific.c" 2
# 22 "Sys_Time_MCU_Specific.c"
void Sys_Time_Init(void)
{
...
void Sys_Time_ISR(void)
{
    ...
    if (PIE3bits.TMR2IE && PIR3bits.TMR2IF) {
        PIR3bits.TMR2IF = 0;
        MCU_Time_Increase_Unit();
    }

}
# 70 "Sys_Time_MCU_Specific.c"
void MCU_Time_Process(void)
{
