...
# 7 "Dev_Uart.c" 2
# 25 "Dev_Uart.c"
static volatile uint8_t s_tx_buf[128u];
...
void UART_Init(void)
{
    ...
    U1CON0bits.BRGS = 1;
    U1BRGL = (uint8_t)(((uint16_t)(((64000000UL + (2UL*38400UL)) / (4UL*38400UL)) - 1UL)) & 0xFF);
    U1BRGH = (uint8_t)(((uint16_t)(((64000000UL + (2UL*38400UL)) / (4UL*38400UL)) - 1UL)) >> 8);
...
void UART_ISR(void)
{
    ...
    if (PIE4bits.U1TXIE && PIR4bits.U1TXIF) {
        if (s_tx_count > 0) {
            ...
            s_tx_tail = (uint8_t)((s_tx_tail + 1u) % 128u);
            s_tx_count--;
        }
        if (s_tx_count == 0) {
            PIE4bits.U1TXIE = 0;
...
_Bool print_char(char c)
{
    ...
    s_tx_head = (uint8_t)((s_tx_head + 1u) % 128u);
    s_tx_count++;
    PIE4bits.U1TXIE = 1;
...
uint8_t UART_TX_Free(void)
{
    return (uint8_t)(128u - s_tx_count);
}
